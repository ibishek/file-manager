...
<aside class="w-64 md:w-48 lg:w-64  h-screen bg-white hidden md:block">
    ...
    <nav class="mt-10">
        <button
            class="flex items-center py-2 w-full px-8 {$page.url.endsWith(
                '/dashboard'
            )
                ? 'bg-gray-200 border-r-4 border-blue-500 text-gray-700'
                : 'text-gray-600 hover:bg-gray-200 hover:text-gray-700 hover:border-r-4 hover:border-blue-500'}"
            use:inertia={{
                method: "get",
                href: "/",
            }}
        ...
        <ul>
            <div
                class="flex items-center mt-5 py-2 w-full px-8 text-gray-600 
                {$page.url.endsWith('/files')
                    ? 'bg-gray-200 border-r-4 border-blue-500 text-gray-700'
                    : 'text-gray-600 hover:bg-gray-200 hover:border-r-4 hover:text-gray-700 hover:border-blue-500'}"
            >
                <svg
                ...
                <span class="mx-4 font-medium">Files</span>
            </div>
            <div class="text-left">
                <li>
                    <button
                        class="w-full py-2 px-8 {$page.url.endsWith('/files')
                            ? 'bg-gray-200 border-r-4 border-blue-500 text-gray-700'
                            : 'text-gray-600 hover:bg-gray-200 hover:text-gray-700 hover:border-r-4 hover:border-blue-500'}"
                    >
                        All Files
                ...
                <li>
                    <button
                        class="w-full py-2 px-8 {$page.url.endsWith(
                            '/files/create'
                        )
                            ? 'bg-gray-200 border-r-4 border-blue-500 text-gray-700'
                            : 'text-gray-600 hover:bg-gray-200 hover:text-gray-700 hover:border-r-4 hover:border-blue-500'}"
        ...
        <a
            class="flex items-center mt-5 py-2 px-8 w-full text-gray-600 border-r-4 border-white hover:bg-gray-200 hover:text-gray-700 hover:border-blue-500"
            href="/"
        >
            <svg
                class="h-5 w-5 stroke-current"
            ...
            <span class="mx-4 font-medium">File Owners</span>
        </a>
        ...
        >
            ...
            <span class="mx-4 font-medium">Staffs</span>
        </a>
    </nav>
...
{#if showSidebar}
    <aside class="w-64 absolute h-screen bg-white top-16 block md:hidden">
        <div class="flex items-center justify-center mt-10">
            <img
                class="h-6"
                src="https://tailwindui.com/img/logos/workflow-logo-indigo-500-mark-white-text.svg"
        ...
        <nav class="mt-10">
            ...
            <a
                class="flex items-center mt-5 py-2 px-8 text-gray-600 border-r-4 border-white hover:bg-gray-200 hover:text-gray-700 hover:border-blue-500"
                href="/"
            >
                <svg
                    class="h-5 w-5"
